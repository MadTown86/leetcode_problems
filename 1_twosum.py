...
class Solution:
    ...
    def twoSum(self, nums: list[int], target: int) -> list[int]:
        ...
        m = (low + h) // 2
        while step < len(nums):
            print(sort_nums[step][1])
            stepum = sort_nums[step][1]
            if sort_nums[h][1] + sort_nums[step][1] == target:
                return [sort_nums[h][0], sort_nums[step][0]]
            elif h - low == 1 and step != h:
                print(h)
                print(low)
                print(step)
                if sort_nums[step][1] + sort_nums[step + 1][1] == target:
                    return [sort_nums[step][0], sort_nums[step + 1][0]]
                elif sort_nums[step][1] + sort_nums[step - 1][1] == target:
                    return [sort_nums[step][0], sort_nums[step - 1][0]]
                elif sort_nums[step + 1][1] + sort_nums[step - 1][1] == target:
                    return [sort_nums[step + 1][0], sort_nums[step - 1][0]]
            low = step
            h = len(nums) - 1
            m = (low + h) // 2
    ...
    def twoSum2(self, n: list[int], t: int) -> list[int]:
